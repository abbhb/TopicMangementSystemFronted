  ...
  <div>
    ...
    >
      ...
      required: true, message: '组员ID不能为空', trigger: 'blur'
          ...
          >
            <el-input v-model="domain.value"></el-input><el-button @click.prevent="removeDomain(domain)">驳回</el-button>
          </el-form-item>

        </div>
        <div style="display: flex;flex-direction: column-reverse">
          <el-button type="primary" v-if="addoredit==='add'" @click="add">添加题目</el-button>
          <el-button type="primary" v-else-if="addoredit==='edit'" @click="bianji">审核题目</el-button>
        </div>
...
export default {
  ...
  methods:{
    ...
    async init() {
      ...
      const data = await Api.TopicTList()
